...
var options = {
url: 'http://affapi.duga.jp/search?version=1.2&appid='+conf.api.appid+'&agentid='+conf.api.agentid+'&bannerid=01&format=json&hits=40&adult=1&sort='+sort+'&category='+req.params.id+'&keyword='+encodeURI(serverData.keywordNg),
method: 'GET',
json:true
}
...
var options2 = {
url: 'http://affapi.duga.jp/search?version=1.2&appid='+conf.api.appid+'&agentid='+conf.api.agentid+'&bannerid=01&format=json&offset='+offset+'&hits=40&adult=1&sort='+sort+'&category='+req.params.id+'&keyword='+encodeURI(serverData.keywordNg),
method: 'GET',
json:true
}
